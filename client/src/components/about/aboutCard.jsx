...
export default function AboutCard({ name, img, contact }) {
    ...
    return (
        <Grid container className={`card ${isRotated ? 'rotated' : ' '}`} sm={12}>
            <Card className='front' style={{ width: '200px', height:'260px',  }} sm={2}>
                <CardContent >
                    ...
                    <Button className='aboutButton' style={{marginLeft:'52px'}} onClick={onRotate}>More</Button>
                </CardContent>
            ...
            <Card className='back' style={{ width: '200px', height:'260px' }}>
                <CardContent>
                    ...
                    <Button className='aboutButton' style={{marginLeft:'52px'}} onClick={onRotate}>Back</Button>
                </CardContent>
