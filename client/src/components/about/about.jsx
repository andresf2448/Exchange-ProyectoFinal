...
export default function About() {
    ...
    let team = [{ name: 'Rodrigo Juarez', contact: 'https://github.com/rodri-juarez', img: 'https://avatars.githubusercontent.com/u/64714468?v=4' }, { name: 'Martín Bobrik', contact: 'https://github.com/martinbobrik', img: 'https://avatars.githubusercontent.com/u/13581554?v=4' }, { name: 'Javier Castro', contact: 'https://github.com/javicastro89', img: 'https://avatars.githubusercontent.com/u/69270095?v=4' },
